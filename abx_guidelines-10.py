...
ABX_GUIDELINES = {
    ...
    "Ciprofloxacin": {
        ...
        "preg_note_en": ("⚠️ Pregnancy Caution — Ciprofloxacin:\n"
                "  Use with Caution — NOT first-line in pregnancy.\n"
                "  Recent evidence (ENTIS 2024 / BMJ 2023): teratogenicity risk lower than previously thought — but still not recommended.\n"
                "  Use only when: no safer alternative exists + medically necessary.\n"
    ...
    "Levofloxacin": {
        ...
        "preg_note_en": ("⚠️ Use with Caution — Levofloxacin in Pregnancy:\n"
                "  Fluoroquinolone — not first-line in pregnancy.\n"
    ...
    "Ofloxacin": {
        ...
        "preg_note_en": ("⚠️ Use with Caution — Ofloxacin in Pregnancy:\n"
                "  Fluoroquinolone — not first-line in pregnancy.\n"
                "  Recent evidence (ENTIS 2024): teratogenicity risk lower than previously thought.\n"
                "  Use only when no safer alternative exists.\n"
                "  >>> Final decision: treating physician exclusively. <<<"),
    ...
    "Norfloxacin": {
        ...
        "preg_note_en": ("⚠️ Use with Caution — Norfloxacin in Pregnancy:\n"
                "  Fluoroquinolone — not first-line in pregnancy.\n"
                "  Recent evidence (ENTIS 2024): teratogenicity risk lower than previously thought.\n"
    ...
    "Nitrofurantoin": {
        ...
        "preg_note_en": ("⚠️ Pregnancy Caution — Nitrofurantoin:\n"
                "  ✅ Safe in 1st and 2nd trimester for UTI treatment (ACOG 2023).\n"
                "  ⛔ Avoid in 3rd trimester, especially near term (≥36 weeks):\n"
                "     → Risk of fetal hemolytic anemia (G6PD deficiency).\n"
                "     → Neonatal hemolysis at delivery.\n"
                "  Alternative in 3rd trimester: Fosfomycin (single dose) or Cephalosporin.\n"
                "  >>> Final decision: treating physician exclusively. <<<"),
        "child_safe": True,
    ...
    "Fosfomycin": {
        ...
        "preg_note_en": ("⚠️ Pregnancy Caution — Fosfomycin:\n"
    ...
    "Gentamicin": {
        ...
        "preg_note_en": ("⛔ Contraindicated in Pregnancy — Gentamicin:\n"
    ...
    "Amikacin": {
        ...
        "preg_note_en": ("⛔ Contraindicated in Pregnancy — Amikacin:\n"
                "  Fetal ototoxicity — FDA Category D.\n"
                "  Crosses placenta — risk of permanent fetal hearing loss."),
        "child_safe": True,
        "interacts_with": ["NSAIDs (مسكنات الألم)"],
    ...
    "Clarithromycin": {
        ...
        "preg_note_en": ("⛔ Contraindicated in Pregnancy — Clarithromycin:\n"
                "  Associated with congenital malformations in animal and human studies.\n"
    ...
    "Trimethoprim/Sulfamethoxazole": {
        ...
        "preg_note_en": ("⛔ Contraindicated in Pregnancy — TMP/SMX:\n"
                "  Folate antagonist — risk of Neural Tube Defects in 1st trimester.\n"
                "  Causes kernicterus in fetus in 3rd trimester."),
        "child_safe": True,
        "interacts_with": ["Warfarin (مضادات التخثر)"],
    ...
    "Metronidazole": {
        ...
        "preg_note_en": ("⚠️ Pregnancy Caution — Metronidazole:\n"
                "  ACOG 2021 (updated): recent evidence has refuted previous malformation concerns.\n"
    ...
    "Tinidazole": {
        ...
        "preg_note_en": ("⛔ Contraindicated in Pregnancy — Tinidazole:\n"
                "  Contraindicated in 1st trimester.\n"
                "  Prefer to avoid throughout pregnancy — replace with Metronidazole."),
        "child_safe": False,
        "interacts_with": ["Warfarin (مضادات التخثر)"],
    ...
    "Doxycycline": {
        ...
        "preg_note_en": ("⛔ Contraindicated in Pregnancy — Doxycycline (Tetracycline class):\n"
                ...
                "  ACOG 2023 / BNF 2025: do NOT use in pregnancy under any circumstances.\n"
                "  Alternative: Amoxicillin-Clavulanate, Cephalosporin, or Azithromycin."),
        "child_safe": False,
    ...
    "Imipenem/Cilastatin": {
        ...
        "preg_note_en": ("⚠️ Pregnancy Caution — Imipenem/Cilastatin:\n"
                "  Limited human data — Category C.\n"
                "  When a carbapenem is needed in pregnancy: Meropenem preferred (better safety data).\n"
                "  Use Imipenem only if Meropenem is unavailable and clinical condition is critical.\n"
                "  >>> Final decision: treating physician exclusively. <<<"),
        "child_safe": True,
    ...
    "Vancomycin": {
        ...
        "preg_note_en": ("⚠️ Pregnancy Caution — Vancomycin:\n"
                "  Use only when critically necessary (MRSA in pregnancy).\n"
                "  Monitor renal function and fetal/maternal hearing.\n"
                "  >>> Final decision: treating physician exclusively. <<<"),
        "child_safe": True,
        "interacts_with": ["NSAIDs (مسكنات الألم)"],
    ...
    "Linezolid": {
        ...
        "preg_note_en": ("⛔ Contraindicated in Pregnancy — Linezolid:\n"
                "  Demonstrated fetal toxicity in animal studies.\n"
                "  Use only when no alternatives are available."),
        "child_safe": True,
    ...
    "Colistin": {
        ...
        "preg_note_en": ("⚠️ Use with Caution — Colistin in Pregnancy:\n"
...
_EXTRA_ENTRIES = {
    ...
    "Tetracycline": {
        ...
        "preg_note_en": ("⛔ Contraindicated in Pregnancy — Tetracycline (Tetracycline class):\n"
                "  Chelates into fetal bone and teeth → permanent tooth discoloration and inhibited bone growth.\n"
    ...
    "Cephradine": {
        ...
        "preg_note_en": ("✅ Acceptable in Pregnancy — Category B (ACOG)."),
        "child_safe": True,
...
_EXTRA_ENTRIES_2 = {
    "Cefazolin": {
        ...
        "preg_note_en": ("✅ Acceptable in Pregnancy — Category B. Safe throughout all three trimesters."),
        "child_safe": True,
        "interacts_with": [],
    ...
    "Aztreonam": {
        ...
        "preg_note_en": ("⚠️ Category B — Limited human data.\n"
                "Crosses placenta — use only when medically necessary.\n"
                "Final decision: treating physician."),
        "child_safe": True,
        "interacts_with": [],
    ...
    "Gatifloxacin": {
        ...
        "preg_note_en": ("⛔ Contraindicated in Pregnancy — Fluoroquinolone class:\n"
                "  Demonstrated fetal toxicity in animal studies.\n"
                "  ACOG: avoid throughout all trimesters.\n"
                "  Alternative: Beta-lactam or Azithromycin."),
        "child_safe": False,
    ...
    "Moxifloxacin": {
        ...
        "preg_note_en": ("⛔ Contraindicated in Pregnancy — Fluoroquinolone class:\n"
                "  Documented fetal toxicity in animal studies.\n"
                "  ACOG: avoid throughout all trimesters.\n"
                "  Alternative: Amoxicillin-Clavulanate or Azithromycin."),
        "child_safe": False,
    ...
    "Tobramycin": {
        ...
        "preg_note_en": ("⛔ Contraindicated in Pregnancy — Aminoglycoside class:\n"
                "  Documented fetal ototoxicity — permanent hearing loss.\n"
                "  Crosses placenta at high rate.\n"
                "  ACOG: absolute contraindication.\n"
                "  Alternative: Aztreonam (Gram-negative) or Cephalosporin."),
        "child_safe": True,
...
_EXTRA_ENTRIES_3 = {
    ...
    "Erythromycin": {
        ...
        "preg_note_en": ("⚠️ Erythromycin in Pregnancy:\n"
                "  Erythromycin Base/Stearate: acceptable (safest macrolide in pregnancy).\n"
                "  ⛔ Erythromycin Estolate: contraindicated — hepatotoxicity risk to mother.\n"
                "  Azithromycin preferred as a safer alternative with fewer drug interactions.\n"
                "  >>> Final decision: treating physician exclusively. <<<"),
        "child_safe": True,
    ...
    "Clindamycin": {
        ...
        "preg_note_en": ("⚠️ Clindamycin in Pregnancy:\n"
                "  Acceptable when medically necessary (Category B).\n"
                "  Used in Bacterial Vaginosis treatment and GBS prophylaxis in penicillin-allergic patients.\n"
                "  Avoid high doses in 1st trimester when possible.\n"
                "  >>> Final decision: treating physician exclusively. <<<"),
        "child_safe": True,
    ...
    "Oxacillin": {
        ...
        "preg_note_en": ("✅ Acceptable in Pregnancy — Penicillin class.\n"
                "Reasonable safety data. Used in MSSA bacteremia during pregnancy.\n"
                "Cefazolin preferred due to more available safety data."),
        "child_safe": True,
    ...
    "Penicillin": {
        ...
        "preg_note_en": ("✅ Safe in Pregnancy — Most commonly used for GBS prophylaxis and Streptococcal infections. ACOG 2023."),
        "child_safe": True,
    ...
    "Fusidic acid": {
        ...
        "preg_note_en": ("⚠️ Fusidic Acid in Pregnancy:\n"
                "  Limited human data — use only when medically necessary.\n"
                "  Topical: generally acceptable.\n"
                "  Systemic: avoid in 3rd trimester (theoretical kernicterus risk).\n"
                "  >>> Final decision: treating physician exclusively. <<<"),
        "child_safe": True,
