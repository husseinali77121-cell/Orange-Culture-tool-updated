...
if uploaded:
    ...
    with col2:
        ...
        if final_drugs:
            ...
            st.caption("Professional A4 English-only PDF (Arabic unsupported in ReportLab)")
            ...
            if REPORTLAB_AVAILABLE:
                ...
                try:
                    ...
                    if _pdf_bytes:
                        st.download_button(
                            "📄 Download PDF Report (English)",
                            data=_pdf_bytes,
                            file_name=(f"OrangeLab_{organism_type.replace(' ','_')}_"
                        ...
                        st.error("PDF generation returned empty — check reportlab installation")
