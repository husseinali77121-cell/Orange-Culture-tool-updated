...
/* deep-navy background with a soft bio-luminescent glow (circuitry depth) */
.stApp {{
  background:
    radial-gradient(1100px 520px at 88% -8%, rgba(0,229,160,.08), transparent 60%),
    radial-gradient(900px 480px at 6% 108%, rgba(255,122,26,.06), transparent 60%),
    {BG} !important;
...
/* 0px corners everywhere — console look */
...
/* generic text + links */
.stApp p, .stApp li, .stApp span, .stMarkdown {{ color:{TEXT}; }}
