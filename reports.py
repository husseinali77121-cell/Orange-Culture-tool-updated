...
.confidential { background:#fdf2f2; color:#922b21; font-weight:bold; text-align:center;
    ...
    H.append(
        '<div class="footer">'
        f'Generated by Orange Lab AST-QA Engine | {REFS_LINE}<br>'
...
# ══════════════════════════════════════════════════════════════════════════
# ── Guideline citations — ONE source for every output in this module ────────
# Previously each renderer carried its own hard-coded string, and they had
# drifted apart AND were wrong in the same way:
#   • "IDSA AMR 2025" does not exist. The current IDSA guidance on
#     antimicrobial-resistant gram-negative infections is the 2024 (4th) update,
#     which states that it replaces previous versions.
#   • "WHO AWaRe 2025" does not exist either — the latest published edition is
#     2023.
#   • "EUCAST 2026" / "CLSI M100 2026" name a year, not a version. Two reports
#     from different months of the same year can be interpreted against
#     different breakpoints, so the year alone cannot say which table was used.
#     ISO 15189:2022 expects that to be traceable from the report.
# A citation nobody can look up is not a citation.
GUIDELINE_REFS = [
    "EUCAST v16.0 (2026)",
    "CLSI M100 Ed36 (2026)",
    "EUCAST Expert Rules v3.3",
    "IDSA AMR Guidance 2024 (4th update)",
    "WHO AWaRe 2023",
    "WHO BPPL 2024",
    "CLSI M39 5th ed.",
    "Magiorakos 2012",
...
REFS_LINE = " | ".join(GUIDELINE_REFS)

_AR_RE = re.compile(r'[\u0600-\u06FF]')

_AR2EN_PHRASES_RAW = {
    # ── Pregnancy-note sentences (ABX_GUIDELINES "preg_note") ──────────────
    # Recurring "Use with Caution — <drug> في الحمل:" stems (the drug name is
    # left in place; only the Arabic wrapper is translated).
    ...
    "⚠️ Erythromycin في الحمل:": "⚠️ Erythromycin in pregnancy:",
    "⚠️ Clindamycin في الحمل:": "⚠️ Clindamycin in pregnancy:",
    "⚠️ Fusidic acid في الحمل:": "⚠️ Fusidic acid in pregnancy:",
    "⚠️ Category B — بيانات بشرية محدودة.":
        "⚠️ Category B — limited human data.",
    "⚠️ Bioavailability منخفضة (35%) — تركيز محدود خارج البول.":
        "⚠️ Low bioavailability (35%) — limited concentration outside urine.",
    "EMA/BNF 2025: مقبول بجرعة واحدة (3g) لـ uncomplicated UTI في الحمل.":
        "EMA/BNF 2025: acceptable as a single 3g dose for uncomplicated UTI in pregnancy.",
    "خيار مفضل على Nitrofurantoin في الـ 3rd trimester.":
        "Preferred over Nitrofurantoin in the 3rd trimester.",
    "بيانات أكثر طمأنينة من الـ Fluoroquinolones.":
        "More reassuring data than the fluoroquinolones.",
    "ACOG 2021 (updated): الأدلة الحديثة دحضت مخاوف التشوهات القديمة.":
        "ACOG 2021 (updated): recent evidence has refuted the old malformation concerns.",
    "مقبول في كل trimesters عند الضرورة الطبية.":
        "Acceptable in all trimesters when medically necessary.",
    "يُفضل تجنبه في الـ 1st trimester عند وجود بديل آمن.":
        "Best avoided in the 1st trimester when a safe alternative exists.",
    "يُستخدم عند الضرورة القصوى (MRSA في الحمل).":
        "Use only in extreme necessity (MRSA in pregnancy).",
    "مراقبة وظائف الكلى والسمع للأم والجنين.":
        "Monitor maternal and fetal renal and auditory function.",
    ...
    "يُستخدم فقط لإنقاذ الحياة في XDR gram-negatives عند غياب أي بديل.":
        "Use only as life-saving therapy in XDR gram-negatives when no alternative exists.",
    "BNF 2025: تجنّب ما أمكن — monitor renal function closely.":
        "BNF 2025: avoid where possible — monitor renal function closely.",
    "Erythromycin Base/Stearate: مقبول (الأكثر أماناً من الماكروليدات في الحمل).":
        "Erythromycin Base/Stearate: acceptable (the safest macrolide in pregnancy).",
    "⛔ Erythromycin Estolate: ممنوع — خطر كبدي على الأم.":
        "⛔ Erythromycin Estolate: contraindicated — maternal hepatic risk.",
    "يُفضل Azithromycin كبديل أكثر أماناً وأقل تفاعلاً دوائياً.":
        "Azithromycin is preferred as a safer alternative with fewer drug interactions.",
    "مقبول للاستخدام عند الضرورة (Category B).":
        "Acceptable for use when necessary (Category B).",
    "يُستخدم في علاج Bacterial Vaginosis والـ GBS prophylaxis عند الحساسية للبنسيلين.":
        "Used for Bacterial Vaginosis and GBS prophylaxis in penicillin allergy.",
    "تجنّب الجرعات العالية في الـ 1st trimester ما أمكن.":
        "Avoid high doses in the 1st trimester where possible.",
    "مقبول في الحمل — Penicillin class.":
        "Acceptable in pregnancy — Penicillin class.",
    "بيانات سلامة معقولة. يُستخدم في MSSA bacteremia في الحمل.":
        "Reasonable safety data. Used for MSSA bacteremia in pregnancy.",
    "يُفضل Cefazolin بسبب توفر بيانات أكثر.":
        "Cefazolin is preferred because more data are available.",
    "آمن في الحمل — الأكثر استخداماً لـ GBS prophylaxis وStreptococcal infections. ACOG 2023.":
        "Safe in pregnancy — most used for GBS prophylaxis and streptococcal infections. ACOG 2023.",
    "Topical: مقبول عموماً.": "Topical: generally acceptable.",
    "Systemic: تجنّب في الـ 3rd trimester (خطر kernicterus نظرياً).":
        "Systemic: avoid in the 3rd trimester (theoretical kernicterus risk).",
    "القرار النهائي للطبيب المعالج حصراً.":
        "Final decision rests solely with the treating physician.",
    "القرار النهائي للطبيب المعالج حسب الـ trimester.":
        "Final decision rests with the treating physician, by trimester.",
    "القرار النهائي للطبيب المعالج.":
        "Final decision rests with the treating physician.",
    "لا يُعتبر خطاً أول أبداً في الحمل.":
        "never considered first-line in pregnancy.",
    "لا يُعتبر خطاً أول في الحمل.":
        "not considered first-line in pregnancy.",
    "الأدلة الحديثة (ENTIS 2024 / BMJ 2023): خطر تشوهات خلقية":
        "Recent evidence (ENTIS 2024 / BMJ 2023): risk of congenital malformation",
    "الأدلة الحديثة (ENTIS 2024): خطر التشوهات أقل مما كان يُعتقد.":
        "Recent evidence (ENTIS 2024): malformation risk is lower than previously thought.",
    "أقل مما كان يُعتقد — لكن لا يزال غير مستحسن.":
        "lower than previously thought — but still not advisable.",
    "أقل مما كان يُعتقد — لكن لا يزال غير مستصاف.":
        "lower than previously thought — but still not advisable.",
    "يُستخدم فقط عند: انعدام البديل الأكثر أمانًا + الضرورة الطبية.":
        "Use only when: no safer alternative exists AND medically necessary.",
    "يُستخدم فقط عند انعدام البديل الأكثر أمانًا.":
        "Use only when no safer alternative exists.",
    "يُستخدم فقط عند انعدام البدائل.":
        "Use only when no alternatives exist.",
    "سُمية للأذن الجنينية (ototoxicity) — FDA Category D.":
        "Fetal ototoxicity — FDA Category D.",
    "سُمية للأذن الجنينية موثقة — فقدان سمع دائم.":
        "Documented fetal ototoxicity — permanent hearing loss.",
    "يعبر المشيمة — خطر فقدان السمع الدائم للجنين.":
        "Crosses the placenta — risk of permanent fetal hearing loss.",
    "يعبر المشيمة بنسبة عالية.": "Crosses the placenta to a high degree.",
    "يعبر المشيمة — يُستخدم عند الضرورة فقط.":
        "Crosses the placenta — use only when necessary.",
    "يترسّب في عظام وأسنان الجنين → تصبغ دائم وتثبيط نمو العظام.":
        "Deposits in fetal bone and teeth → permanent staining and inhibition of bone growth.",
    ...
    "ACOG 2023 / BNF 2025: لا يُستخدم في الحمل إطلاقاً.":
        "ACOG 2023 / BNF 2025: never use in pregnancy.",
    "ACOG 2023 / BNF 2025: contraindication مطلقة في كل مراحل الحمل.":
        "ACOG 2023 / BNF 2025: absolute contraindication in all stages of pregnancy.",
    "البديل: Amoxicillin-Clavulanate أو Cephalosporin أو Azithromycin.":
        "Alternatives: Amoxicillin-Clavulanate, Cephalosporin, or Azithromycin.",
    "البديل: Amoxicillin-Clavulanate أو Azithromycin.":
        "Alternatives: Amoxicillin-Clavulanate or Azithromycin.",
    "البديل: Beta-lactam أو Azithromycin.":
        "Alternatives: Beta-lactam or Azithromycin.",
    "البديل: Aztreonam (Gram-) أو Cephalosporin.":
        "Alternatives: Aztreonam (Gram-negative) or Cephalosporin.",
    "البديل الآمن: Azithromycin.": "Safe alternative: Azithromycin.",
    "أثبتت سُمية للجنين في الحيوانات.":
        "Demonstrated fetal toxicity in animals.",
    "سُمية للجنين موثقة في الحيوانات.":
        "Documented fetal toxicity in animals.",
    "أثبت سُمية جنينية في الحيوانات.":
        "Demonstrated fetal toxicity in animals.",
    "ACOG: تجنّب في كل مراحل الحمل.":
        "ACOG: avoid in all stages of pregnancy.",
    "ACOG: contraindication مطلقة.": "ACOG: absolute contraindication.",
    "مقبول في الحمل — Category B. آمن في كل الثلاثة أشهر.":
        "Acceptable in pregnancy — Category B. Safe in all three trimesters.",
    "مقبول في الحمل — Category B (ACOG).":
    ...
    "بيانات بشرية محدودة — يُستخدم عند الضرورة فقط.":
        "Limited human data — use only when necessary.",
    "ارتبط بتشوهات خلقية في الدراسات الحيوانية والبشرية.":
        "Associated with congenital malformation in animal and human studies.",
    "يثبط حمض الفوليك — خطر Neural Tube Defects في الـ 1st trimester.":
        "Inhibits folic acid — risk of neural tube defects in the 1st trimester.",
    "يسبب kernicterus للجنين في الـ 3rd trimester.":
        "Causes fetal kernicterus in the 3rd trimester.",
    "عند الحاجة لكاربابينيم في الحمل: يُفضل Meropenem (بيانات أكثر أمانًا).":
        "When a carbapenem is needed in pregnancy: Meropenem is preferred (safer data).",
    "يُستخدم Imipenem فقط عند تعذّر Meropenem وخطورة الحالة.":
        "Use Imipenem only when Meropenem is unavailable and the case is severe.",
    "ممنوع في الـ 1st trimester.": "Contraindicated in the 1st trimester.",
    "يُفضل تجنبه طوال الحمل — استبدل بـ Metronidazole.":
        "Best avoided throughout pregnancy — substitute Metronidazole.",
    "ممنوع في الحمل": "Contraindicated in pregnancy",
    "تحذير حمل": "Pregnancy warning",
    "آمن في كل الثلاثة أشهر.": "Safe in all three trimesters.",
    "آمن في الـ 1st و 2nd trimester لعلاج UTI (ACOG 2023).":
        "Safe in the 1st and 2nd trimester for UTI (ACOG 2023).",
    "تجنّب في الـ 3rd trimester وخاصة عند الـ term (≥36 أسبوع):":
        "Avoid in the 3rd trimester, especially at term (>=36 weeks):",
    "خطر hemolytic anemia في الجنين (G6PD deficiency).":
        "risk of fetal hemolytic anemia (G6PD deficiency).",
    "neonatal hemolysis عند الوليد.": "neonatal hemolysis in the newborn.",
    "البديل في الـ 3rd trim: Fosfomycin (جرعة واحدة) أو Cephalexin.":
        "Alternative in the 3rd trimester: Fosfomycin (single dose) or Cephalexin.",
    # ── Drug-note boilerplate (ABX_GUIDELINES "note" / "renal_note") ───────
    # These are the formulaic fragments the drug notes are actually built from.
    # They are here rather than in _AR2EN_WORDS because word-by-word
    # substitution is what mangled them: "واسع الطيف جداً" is one idea ("very
    # broad spectrum"), and translating "واسع"→"broad" / "جداً"→"very" while
    # dropping "الطيف" produced "broad very". Phrases are matched
    # longest-first (see _AR2EN_PHRASES), so a phrase always wins over its own
    # words. Anything still untranslated after this table now yields an explicit
    # marker instead of a deleted word — see _ar2en().
    "خيار قياسي للعدوى البسيطة والمتوسطة": "standard option for mild-to-moderate infection",
    "للموجبات والسالبات":            "against Gram-positives and Gram-negatives",
    "أساس علاج":                      "mainstay of treatment for",
    "بجرعات عالية":                   "at high doses",
    "بجرعات":                         "at doses",
    "واسع الطيف جداً":                "very broad spectrum",
    "واسع الطيف":                     "broad spectrum",
    "يُحفظ للحالات الشديدة":          "reserve for severe cases",
    "يُحفظ للحالات":                  "reserve for cases",
    "للحالات التي تحتاج حقن":         "for cases requiring injection",
    "تغطية ممتازة لـ":                "excellent coverage of",
    "تغطية ممتازة":                   "excellent coverage",
    "لا يغطي":                        "does not cover",
    "يغطي":                           "covers",
    "يتركز في البول":                 "concentrates in urine",
    "يتركز":                          "concentrates",
    "للعدوى الجهازية":                "for systemic infection",
    "الجهازية":                       "systemic",
    "العدوى البسيطة والمتوسطة":       "mild-to-moderate infection",
    "والمتوسطة":                      "and moderate",
    "الخيار الأساسي":                 "the primary option",
    "الأساسي":                        "primary",
    "الجرعات العالية":                "high doses",
    "العالية":                        "high",
    "القصور الكلوي":                  "renal impairment",
    "الكلوي":                         "renal",
    "لاستبعاد":                       "to rule out",
    "بما فيها":                       "including",
    "أفضل من":                        "better than",
    "أفضل":                           "better",
    # NOTE: single-token conjunctions/particles ("و", "لـ", "ضد", "نفس") were
    # removed from this PHRASE table. Phrase substitution matches on SUBSTRING,
    # so "و" here rewrote the waw INSIDE words — "فموي" (oral) became "فمandي",
    # "واسع" (broad) became "andاسع". These particles are handled by the
    # word-level pass in _ar2en() instead, which matches a whole Arabic run at
    # once and so only ever translates them when they stand alone. The leading-
    # waw case ("واسع" = "and" + "اسع"? no — it's one word) is also handled
    # there by the _word_sub helper.
    "إلا":                            "except",
    "البول":                          "urine",
    "الحالات":                        "cases",
    "الطيف":                          "spectrum",
    "تأكيد سالب":                     "negative confirmation",
    "صفر":                            "zero",
...
# ── العينات اللي فيها Pus cells / RBCs بالمجهر معنى إكلينيكي ────────────────
# مصدر واحد للحقيقة، بيستورده التطبيق كمان. لازم الشاشة والصورة يتفقوا، وإلا
# الحقل يظهر في الـ UI وتطبع الصورة "N/A" (أو العكس) — وده اللي كان بيحصل.
#   urine   → pyuria (≥10 WBC/HPF) / haematuria
#   wound   → pus cells
#   stool   → fecal leukocytes: بيفرّقوا inflammatory/invasive diarrhea
#             (Shigella, Campylobacter, EIEC, Salmonella, C. difficile) عن
#             secretory diarrhea (ETEC, Vibrio, viral, Giardia)؛ والـ RBCs
#             علامة dysentery (Shigella, EHEC/STEC, E. histolytica).
#   genital → urethritis (≥5 WBC/HPF) / cervicitis (≥10 WBC/HPF)
# مستبعدة عن قصد: blood و csf (العدّ بيتقاس /µL مش /HPF)، sputum (ليها
# Murray-Washington بـ WBC/LPF + Epi/LPF)، throat، respiratory.
MICROSCOPY_SPECIMENS = frozenset({"urine", "wound", "stool", "genital"})

# ── العينات اللي فيها Colony Count معنى ────────────────────────────────────
# البول بس. العدّ الكمّي هو تعريف الـ significant bacteriuria نفسه
# (≥ 10^5 CFU/mL). مزرعة البراز **كيفية**: نمو Salmonella / Shigella /
# Campylobacter معناه مرضي بغض النظر عن العدد، والعدّ وسط الفلورا الطبيعية
# بلا معنى أصلاً. ونفس الكلام على الجرح والبلغم والدم والـ CSF.
COLONY_COUNT_SPECIMENS = frozenset({"urine"})


_AR2EN_PHRASES = sorted(_AR2EN_PHRASES_RAW.items(), key=lambda kv: len(kv[0]), reverse=True)

_AR2EN_WORDS = {
    # Conjunctions/particles — here (not in the phrase table) so they only match
    # a whole standalone Arabic word and can never split واسع/فموي/تنفسي.
    "و": "and", "لـ": "for", "ضد": "against", "نفس": "same as", "يشمل": "including",
    "الـ": "", "للـ": "for", "على": "for", "غير": "not", "مهم": "important",
    # Long descriptive-note vocabulary (ABX_GUIDELINES "note").
    "للمسالك": "for UTI", "التنفسي": "respiratory", "والجهاز": "and the",
    "للجهاز": "for the", "الجهاز": "the", "الخيار": "the option", "الأول": "first-line",
    "اللاهوائيات": "anaerobes", "واللاهوائيات": "and anaerobes", "للأنيروبيك": "for anaerobes",
    "تأكيد": "confirm", "الحرجة": "critical", "للحالات": "for cases", "تركيزه": "its concentration",
    "عالٍ": "high", "للكلى": "for the kidneys", "المقاومة": "resistance", "للمقاومة": "resistance",
    "ممتاز": "excellent", "الملاذ": "the last", "الأخير": "resort", "مراقبة": "monitor",
    "تغطية": "coverage", "مفيد": "useful", "الحساسية": "sensitivity", "لعدوى": "for infection",
    "البطن": "abdomen", "مفضل": "preferred", "يُفضل": "preferred", "تُستخدم": "used",
    "يستخدم": "used", "سالب": "negative", "السالبات": "Gram-negatives", "والسالبات": "and Gram-negatives",
    "الموجبات": "Gram-positives", "والموجبات": "and Gram-positives", "مزيج": "combination",
    "بروتوكولات": "protocols", "المصرية": "Egyptian", "المعقدة": "complicated", "متاح": "available",
    "سام": "toxic", "النسيجي": "tissue", "الأرجح": "likely", "للكلاميديا": "for chlamydia",
    "والمايكوبلازما": "and mycoplasma", "أوسع": "broader", "طيفاً": "spectrum", "أوسع طيفاً": "broader spectrum",
    "نوبات": "seizures", "صرع": "epilepsy", "يمنع": "prevents", "يومية": "daily",
    "خطراً": "risk", "ادخاره": "reserving it", "الحيوية": "vital", "شديد": "severe",
...
_EN_UNAVAILABLE = "[Arabic clinical note — see the Arabic report]"


def _ar2en(text, en=True):
    """Render Arabic clinical wording in English.

    No-op for the Arabic report (`en=False`) and for text that has no Arabic.

    THREE PASSES, from most to least reliable, and it NEVER deletes text:

      1. Whole-phrase substitution (`_AR2EN_PHRASES`, matched longest-first).
         This is where the real clinical sentences live, authored by hand, so a
         full sentence always beats its own fragments. This handles the vast
         majority of the fixed report wording (banned reasons, pregnancy notes,
         renal notes).

      2. Word-level substitution (`_AR2EN_WORDS`) for anything phrase-matching
         did not cover — individual terms rendered one by one.

      3. Last resort: if a few Arabic words STILL remain (a rare term not in
         either table), leave those specific words in place inside otherwise
         English text and log them, rather than emitting a placeholder for the
         whole line.

    The history that shaped this: an earlier version ended by DELETING every
    unknown Arabic run, which — because the word table also maps bare function
    words ("لا"→"no") — substituted half a sentence and deleted the rest, so
    "...حتى لو أظهرت المزرعة حساسية" ("even if the culture reports susceptible")
    became "until susceptibility", the OPPOSITE instruction. A later version
    swapped deletion for a "[see Arabic report]" marker, which was safe but left
    whole pregnancy-note lines as placeholders. Both were wrong for the reader:
    the reader wants the sentence in English. So we translate as much as the
    tables allow and, in the worst case, surface a mostly-English line with a
    stray term left visible — never a silent deletion, never a bare marker.
    """
    if not text or not en or not _AR_RE.search(text):
        return text
    s = text
    # 1) whole-phrase (longest-first)
    for ar_p, en_p in _AR2EN_PHRASES:
        if ar_p in s:
            s = s.replace(ar_p, en_p)
    # 2) word-level for the remainder
    if _AR_RE.search(s):
        def _word_sub(m):
            w = m.group(0)
            if w in _AR2EN_WORDS:
                return _AR2EN_WORDS[w]
            # Handle a leading و (waw of conjunction) that is glued to a word:
            # "واسع" must not become "and-اسع". Strip a leading و, translate the
            # remainder if known, and re-attach "and ". Only do this when the
            # remainder is itself a known word, so we never mangle words that
            # legitimately start with و.
            if len(w) > 1 and w[0] == "و" and w[1:] in _AR2EN_WORDS:
                return "and " + _AR2EN_WORDS[w[1:]]
            return w
        s = re.sub(r'[\u0600-\u06FF]+', _word_sub, s)
        # A particle glued to Latin text ("Oral وIV") translates to "andIV";
        # insert the missing space on either side so it reads "Oral and IV".
        s = re.sub(r'([A-Za-z0-9])(and|for|against|with|or|in|from)([A-Z])',
                   r'\1 \2 \3', s)
    # 3) last resort: keep any stray untranslated word visible (do NOT delete,
    #    do NOT replace the whole line with a marker) and log it so it can be
    #    added to the tables at source.
    if _AR_RE.search(s):
        leftover = " ".join(dict.fromkeys(_AR_RE.findall(s)))
        logger.warning("EN PDF: residual untranslated Arabic %r in %r — "
                       "add to _AR2EN_PHRASES/_AR2EN_WORDS.", leftover[:80], text[:120])
...
def generate_pdf_html_report(
    ...
    # ⚠️ colony_count / pus_cells / rbcs بيتستقبلوا ومش بيتطبعوا في الـ PDF —
    # ده **قرار تصميم مقصود** (٢٠٢٦-٠٧-١٥): الميكروسكوب والعدّ مكانهم الصورة
    # والتقرير النصي، والـ PDF ملخّص إكلينيكي/دوائي. متشيلهمش من التوقيع عشان
    # النداءات القايمة ماتتكسرش، ومتضفهمش للـ HTML "إصلاحاً" لغلط — مش غلط.
    ...
    lang: str = "ar",
    # The standard the BENCH used to produce these S/I/R values. It changes what
    # "I" means on this page, so the page has to be told — and has to print it.
    # Defaulted so existing callers keep working unchanged.
    interp_std: str = "CLSI",
    interp_label: str = "CLSI M100 Ed36 (2026)",
    # NOTE: this function deliberately does NOT take qc_issues. It briefly did,
    # to print a "panel under review" banner — removed, because a laboratory
    # resolves a panel it does not trust rather than publishing it with a
    # caveat. QC findings go to generate_qa_report_pdf() and to the lab's screen.
) -> Optional[bytes]:
    if not WEASYPRINT_AVAILABLE:
        return None
    _EUCAST_MODE = str(interp_std).strip().upper() == "EUCAST"
    ...
    _T = {
        ...
        # "use only if no better option" was hard-coded here and printed on every
        # report regardless of which standard produced the result. Under CLSI it
        # is an over-simplification (the category also covers drugs that
        # concentrate at the site, and a higher-than-normal dose); under EUCAST
        # it is the opposite of what "I" means. Both readings now come from the
        # declared standard.
        "intermediate":  (
            "⚠ I = Susceptible, increased exposure — appropriate ONLY with the "
            "high-dose / prolonged-infusion regimen, not the standard dose"
            if _EUCAST_MODE else
            "⚠ I = Intermediate — USE WITH CAUTION: response rates may be lower "
            "than for a susceptible agent. May still be effective where the drug "
            "concentrates (e.g. urine) or at a higher than normal dose. The "
            "category also includes a technical buffer zone, so the result may "
            "shift on repeat. Prefer a susceptible (S) alternative if one exists."
        ),
        # Patho
...
"""
  ...
  <div class="hdr-right">
    ...
    # NOTE — there is deliberately NO quality-control banner on this page.
    # An earlier version printed "PANEL UNDER REVIEW" here whenever the QA engine
    # raised an error. That was the wrong instrument. A laboratory is responsible
    # for the validity of what it reports: the answer to a panel it does not
    # trust is to resolve it and then report, not to publish it with a caveat and
    # hand the problem to the prescriber. A banner also trains its own audience —
    # print one often enough and it stops being read, including on the day it
    # matters. The QC findings go to generate_qa_report_pdf() (internal, for the
    # microbiologist) and to the lab's own screen BEFORE this PDF is generated,
    # which is where someone can still act on them.
    ...
    if banned:
        ...
        def _ban_reason(bd):
            ...
            # 0. Intrinsic resistance — checked BEFORE the R branch, because an
            # intrinsically resistant drug also carries _sir == "R" and would
            # otherwise be tagged "❌ (R)": presented to the physician as a
            # culture finding about this isolate when it is a property of the
            # species. Every E. coli that has ever existed is clindamycin-R.
            if cat == "intrinsic":
                return ('🧬 Intrinsic', '#5d6d7e')
            # Not in the guideline database — the app has no rules for it, so it
            # must not read as a clinical judgement about the drug.
            if cat == "unknown":
                return ('⚠ Not in database', '#7d6608')
            if cat == "specimen":
                return ('⚠ Wrong specimen', '#b7770d')
        ...
        # Intrinsic resistance is pulled out of the main list. Printed inline
        # with acquired resistance and identical styling, it makes a false
        # statement by implication: Tetracycline-R is a fact about THIS isolate
        # (it acquired a tet gene — real, and worth knowing), while
        # Clindamycin-R is true of the species and always was. Side by side they
        # read to a prescriber as "this organism is resistant to a lot of
        # things", when half the list was never a treatment option to lose.
        def _chip(_bd):
            ...
            return (
                ...
                'border-radius:1.5mm;font-size:8pt;max-width:90mm;'
        ...
        # Intrinsically resistant agents are dropped from this list entirely —
        # not merged back in, and not explained. Two reasons, and the second is
        # the one that settles it:
        #
        #   1. Nothing here changes prescribing. The physician is choosing from
        #      the S list; whether erythromycin appears under AVOID with a
        #      reason, without a reason, or not at all, they were never going to
        #      prescribe it for an E. coli. The explanation is laboratory
        #      education printed on a clinical document.
        #
        #   2. "AVOID" means "this was a candidate, and here is why not". These
        #      were never candidates. Listing them under that heading makes the
        #      isolate look more resistant than it is — the organism did not
        #      acquire anything; the species simply never had the target.
        #
        # The finding is real and still matters — to the LAB, which is putting
        # disks on a plate that can never inform a decision. So it goes to the
        # internal QA report, where someone can fix the panel. The full AST
        # panel as tested is on the laboratory's own C/S report; this is an
        # advisory, not a transcript.
        _other_bd = [b for b in banned if b.get("category") != "intrinsic"]
        if _other_bd:
            H.append(
                '<div class="alert al-danger" style="font-size:8.5pt;line-height:1.6">'
                f'{"".join(_chip(b) for b in _other_bd)}</div>'
            )
    ...
    if warned:
        ...
        if any(_wd.get("warning_reason") == "intermediate_culture" for _wd in warned):
            # Was a second hard-coded copy of the same wrong sentence, drifting
            # independently of _T["intermediate"]. One source now.
            _sub_notes.append(_T["intermediate"])
        if _sub_notes:
    ...
    # Footer
    H.append(f"""<hr class="dv" style="margin-top:1mm">
<div class="grid2">
  <div class="g2l" style="font-size:8pt;color:#666">
    <b>Interpretation standard:</b> {interp_label}<br>
    <b>References:</b> {REFS_LINE}
  </div>
...
def generate_decision_tree_image(
    ...
    # Classify the specimen ONCE, up front. This drives the colony-count guard
    # (below), the Mid-Stream label, and the microscopy block. It was previously
    # defined much lower in the function, yet the colony-count guard near the top
    # already referenced it — so `generate_decision_tree_image` raised
    # "cannot access local variable '_img_cat'" (UnboundLocalError) for every
    # report. Defining it here, right after the PIL check and before any use,
    # removes that crash without changing any downstream behaviour.
    ...
    cc_parts = []
    # حارس حسب **العينة** مش حسب القيمة. `if colony_count:` لوحده كان بيعتمد
    # على إن الشاشة تبعت "" لغير البول — يعني الحماية عند المُنادي مش عند
    # المُولّد، وأي نداء تاني (إعادة طبع من السجل مثلاً) كان هيطبع Colony Count
    # على تقرير براز.
    if colony_count and _img_cat in COLONY_COUNT_SPECIMENS:
    ...
    # (_img_cat is classified once at the top of the function.)
    ...
    # كان مكتوب هنا ("urine", "wound") بالإيد — فحتى لو الشاشة أظهرت الحقل
    # لعينة براز، الصورة كانت تطبع "N/A for this specimen" وتتناقض معاها.
    if _img_cat in MICROSCOPY_SPECIMENS:
        micro_items = [
    ...
    refs = ["EUCAST v16.0 (2026)", "CLSI M100 Ed36 (2026)",
            "IDSA AMR 2024 (4th update)", "WHO AWaRe 2023",
            "EDA Egypt", "BNF 2025 | FDA Labels"]
    ry = FY1 + 30*S
    for ref in refs:
...
def generate_report(
    ...
    # لازم لترتيب المضادات بنفس منطق الشاشة/الصورة/الـ PDF. اختياري بقيمة None
    # عشان أي نداء قديم للدالة ما يتكسرش.
    ...
    # نفس منطق الصورة — الحماية عند المُولّد مش عند المُنادي.
    if colony_count and classify_specimen(specimen) in COLONY_COUNT_SPECIMENS:
    ...
    if allowed:
        # مصدر ترتيب واحد لكل المخرجات. الـ PDF (سطر ٧٣٦) بيعيد الترتيب جواه بـ
        # rank_sensitive_antibiotics، والشاشة والصورة بياخدوا نفس الترتيب — بس
        # التقرير النصي كان بيلف على `allowed` خام بترتيب الإدخال بتاع
        # analyze_antibiotics. النتيجة: نفس الحالة، ترتيب مضادات مختلف في الـ TXT
        # عن الـ PDF. نفس args الـ PDF بالظبط عشان الترتيب يطابقه حرف بحرف.
        _ranked_txt = rank_sensitive_antibiotics(
            allowed, specimen, organism, sir_map, phenotypes or []
        )
        for item in _ranked_txt:
    ...
    if warned:
        ...
        for item in warned:
            ...
            if item.get("warning_reason") == "intermediate_culture":
                # Was the bare label "Intermediate (I) on culture result" and
                # nothing else — the text report told the physician the category
                # but not what to do about it, which is the only part that
                # changes management. The note now travels from the engine
                # (sir_note_en), so this report says the same thing as the screen
                # and the PDF instead of quietly saying less.
                L.append("Reason    : Intermediate (I) on culture result")
                _note = item.get("sir_note_en") or item.get("sir_note_ar")
                if _note:
                    for _ln in textwrap.wrap(str(_note), 66):
                        L.append(f"          : {_ln}")
            else:
    ...
    L += ["\nDISCLAIMER", sep,
          ...
          f"Guidelines: {REFS_LINE}",
          "Route info: BNF 2025 | FDA Labels",
