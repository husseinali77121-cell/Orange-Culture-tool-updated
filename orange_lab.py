...
def analyze_antibiotics(
    ...
    for drug in final_drugs:
        ...
        # CRITICAL pregnancy safety: tetracyclines are CONTRAINDICATED in
        # pregnancy regardless of their "Warn" tag (fetal bone/teeth damage).
        # Fluoroquinolones → caution only (risk now considered lower; physician decides).
        if is_preg and info.get("preg_status") == "Warn":
            if "tetracycline" in cls:
                ...
                continue
            # Fluoroquinolones & other trimester-dependent drugs → caution ONLY.
            # The decision is left to the treating physician (risk re-evaluated as lower).
