...
def generate_pdf_html_report(
    ...
    def _xlate_patho(text: str) -> str:
        ...
        _WORD_EN = {
            ...
            "الحساسية": "sensitivity", "احتجز": "admit", "ومراقبته": "and monitor",
            "بشكل": "", "مكثف": "intensive", "استشر": "consult", "طبيب": "physician",
            "الأمراض": "disease", "المعدية": "infectious", "التزم": "adhere", "بمبادئ": "to principles",
            "تابع": "follow up", "وأعِد": "and repeat", "التقييم": "assessment", "ظهرت": "appear",
            "تشير": "indicate", "المعطيات": "findings", "إلى": "to", "وفقاً": "per",
            "لـ": "", "لا": "do NOT", "تعطِ": "give", "مضادات": "antibiotics", "حيوية": "",
            "بناءً": "based", "هذه": "this", "النتيجة": "result", "العينة": "specimen",
            "من": "from", "موقع": "site", "معقم": "sterile", "أي": "any", "نمو": "growth",
            "يُعدّ": "is", "مرضياً": "pathogenic", "بغض": "regardless", "النظر": "",
            "عن": "of", "العوامل": "factors", "الأخرى": "other", "احتجاز": "admission",
