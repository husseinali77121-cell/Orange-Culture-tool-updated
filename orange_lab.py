...
"""
  ...
  <div class="hdr-right">
    ...
    if ranked:
        ...
        if is_preg and preg_warn_items:
            H.append('<div style="font-size:8pt;color:#6c3483;margin-top:0.5mm">'
                     '🤰 خيارات إضافية بحذر في الحمل — راجع قسم Pregnancy بالأسفل.</div>')
    else:
        H.append('<div class="sec-ttl">Recommended Therapy — Ranked</div>')
        if is_preg and preg_warn_items:
            H.append('<div class="alert al-info" style="font-size:8.5pt">'
                     '🤰 جميع الخيارات الحساسة تتطلب حذراً في الحمل — راجع قسم '
                     'Pregnancy — Use with Caution بالأسفل لاتخاذ القرار.</div>')
        else:
            H.append('<div class="alert al-info" style="font-size:8.5pt">'
    ...
    if interactions:
        H.append('<div class="sec-ttl" style="margin-top:0.6mm">💊 Drug Interactions</div>'
