...
if uploaded:
    ...
    # Compact preview per the layout sketch: small thumbnail + a zoom expander,
    # kept narrow so it doesn't dominate the screen. The user still verifies the
    # antibiogram by expanding to full size.
    ...
    with col1:
        ...
        def _hide_block(anchor_cls):
            """Emit a hide-anchor + scoped CSS that visually collapses the
            Streamlit vertical block containing it (widgets still execute)."""
            st.markdown(
